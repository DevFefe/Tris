...
def main_window():
    ...
    btn4 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn4, 1, 0))
    btn5 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn5, 1, 1))
    btn6 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn6, 1, 2))

    btn7 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn7, 2, 0))
    btn8 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn8, 2, 1))
    btn9 = Button(mainWindow, image = pixelVirtual, width = 100, height = 100, compound = "c", font = ("Courier", 100), command = lambda: insert_symbol(btn9, 2, 2))
